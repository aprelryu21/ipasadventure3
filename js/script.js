...
let scene3D, camera3D, renderer3D, currentModel3D, controls3D;
let animationId3D;
...
function animate3D() {
    ...
    // Putaran etalase otomatis (.rotation.y) dihapus agar pemain leluasa mengeksplorasi secara mandiri
    controls3D.update();
